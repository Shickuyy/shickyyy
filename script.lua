...
if not isfolder("shickyyy") then
    makefolder("shickyyy")
end

if not isfolder("shickyyy/configs") then
    makefolder("shickyyy/configs")
end

if not isfolder("shickyyy/configs/da_hood") then
    makefolder("shickyyy/configs/da_hood")
end
...
local nigga = (function() -- src/Lua/loader.lua
    ...
    function loaderOptions:new()
        ...
        MainTitle.Text = "shickyyy.dahood"
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'shickyyy<font color="rgb(168, 157, 159)">.dahood</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("shickyyy.universal")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("shickyyy/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("shickyyy/configs/da_hood") do
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'shickyyy<font color="rgb(168, 157, 159)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("shickyyy.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
